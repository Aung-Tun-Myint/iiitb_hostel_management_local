 ...
 * 
 */
public class Floor extends BaseResource {
	...
	private Integer room_count = null;
	...
	public static String FIELD_ROOM_COUNT = "room_count";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("floor");
	...
	static {
		...
		Field numberField = new Field("number", "Integer");
		numberField.setRequired(true);
		metaData.addField(numberField);

		Field room_countField = new Field("room_count", "Integer");
		room_countField.setRequired(true);
		metaData.addField(room_countField);
		...
		metaData.setTableName("floor");

		metaData.setCluster("hostel_management_system");
	}

	public Floor() {this.setId(Util.getUniqueId());}
	public Floor(String id) {this.setId(id);}
	...
	public Floor(Floor obj) {
		...
		this.room_count = obj.room_count;
	...
	public Map<String, Object> validateAndConvertResourceToMap(HashMap<String,Object> map,boolean add) throws ApplicationException {
		...
		if(validateBlock_id(add))
			map.put("block_id", block_id);
		if(validateNumber(add))
			map.put("number", number);
		if(validateRoom_count(add))
			map.put("room_count", room_count);
		if(extra_data != null)
			map.put("extra_data", extra_data);
		return map;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		room_count = (Integer) map.get("room_count");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		if(numberObj != null)
			number = new Integer(numberObj.toString());

		Object room_countObj = map.get("room_count");
		if(room_countObj != null)
			room_count = new Integer(room_countObj.toString());
	...
	public boolean validateNumber(boolean add) throws ApplicationException {
		if(add && number == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[number]");
		return number != null;
	}
	...
	public void unSetRoom_count() {
		this.room_count = null;
	}

	public boolean validateRoom_count(boolean add) throws ApplicationException {
		if(add && room_count == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[room_count]");
		return room_count != null;
	}
	...
	public  Class<?> getResultClass() {return FloorResult.class;};
	public  Class<?> getMessageClass() {return FloorMessage.class;};
	public  Class<?> getHelperClass() {return FloorHelper.class;};
	public  Class<?> getServiceClass() {return FloorService.class;};
}
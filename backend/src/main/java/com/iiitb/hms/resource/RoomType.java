 ...
 * 
 */
public class RoomType extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("room_type");
	...
	static {
		...
		Field capacityField = new Field("capacity", "Integer");
		...
		metaData.setTableName("room_type");

		metaData.setCluster("hostel_management_system");
	}

	public RoomType() {this.setId(Util.getUniqueId());}
	public RoomType(String id) {this.setId(id);}
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		if(capacityObj != null)
			capacity = new Integer(capacityObj.toString());
	...
	public boolean validateCapacity(boolean add) throws ApplicationException {
		if(add && capacity == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[capacity]");
	...
	public  Class<?> getResultClass() {return RoomTypeResult.class;};
	public  Class<?> getMessageClass() {return RoomTypeMessage.class;};
	public  Class<?> getHelperClass() {return RoomTypeHelper.class;};
	public  Class<?> getServiceClass() {return RoomTypeService.class;};
}